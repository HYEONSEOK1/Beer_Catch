...
#     Alternatively, it can be generalized to nn.Linear(num_ftrs, len(class_names)).
    ...
    modelc.load_state_dict(torch.load('forServiceTest/weights/resnet18_48class.pt'))
...
#                         vid_writer.write(im0)
            ...
            for crop_name in crop_list:
                ...
                if confidence[predict].item() > 0:
                    print('[%-10s -> %-10s : %g]' % (crop_name, class_names[predict], confidence[predict].item()))
...
if __name__ == '__main__':
    ...
    parser.add_argument('--weights', nargs='+', type=str, default='forServiceTest/weights/best.pt', help='model.pt path(s)')
